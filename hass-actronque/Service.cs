...
namespace HMX.HASSActronQue
{
	internal class Service
	{
		...
		public static void Start()
        {
			...
			Configuration.GetOptionalConfiguration(configuration, "MQTTTLS", out bMQTTTLS, false);

			if (!Configuration.GetConfiguration(configuration, "PerZoneControls", out bPerZoneControls))
				return;

			Configuration.GetOptionalConfiguration(configuration, "PerZoneSensors", out bPerZoneSensors, false);		
			...
			Configuration.GetOptionalConfiguration(configuration, "SeparateHeatCoolTargets", out bSeparateHeatCool, false);
			...
			Que.Initialise(strQueUser, strQuePassword, strQueSerial, strSystemType, iPollInterval, bQueLogging, bPerZoneControls, bPerZoneSensors, bSeparateHeatCool, _eventStop);
